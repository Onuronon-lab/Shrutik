...
class TestAdminEndpoints:
    ...
    def test_get_platform_statistics_admin(
        self, mock_get_stats, mock_get_user, client, mock_admin_user
    ):
    ...
    @patch("app.core.dependencies.get_current_active_user")
    @patch("app.services.admin_service.AdminService.get_platform_statistics")
    def test_get_platform_statistics_sworik_dev(
        self, mock_get_stats, mock_get_user, client, mock_sworik_user
    ):
    ...
    def test_get_system_health(
        self, mock_get_health, mock_get_user, client, mock_admin_user
    ):
    ...
    @patch("app.core.dependencies.get_current_active_user")
    def test_get_users_for_management_admin_only(
        self, mock_get_user, client, mock_admin_user
    ):
    ...
    def test_get_usage_analytics(
        self, mock_get_analytics, mock_get_user, client, mock_admin_user
    ):
        ...
        mock_analytics = {
            ...
            "top_contributors": [
                {"user_id": 1, "name": "Top User", "contribution_count": 100}
            ],
        }
    ...
    def test_update_user_role(
        self, mock_update_role, mock_get_user, client, mock_admin_user
    ):
    ...
    def test_create_quality_review(
        self, mock_create_review, mock_get_user, client, mock_admin_user
    ):
