...
class TestAdminEndpoints:
    ...
    def test_get_platform_statistics_admin(self, authenticated_admin_client):
        ...
        with patch("app.services.admin_service.AdminService.get_platform_statistics") as mock_get_stats:
            ...
            response = authenticated_admin_client.get("/api/admin/stats/platform")
    ...
    def test_get_platform_statistics_sworik_dev(self, authenticated_sworik_client):
        ...
        with patch("app.services.admin_service.AdminService.get_platform_statistics") as mock_get_stats:
            ...
            response = authenticated_sworik_client.get("/api/admin/stats/platform")
    ...
    def test_get_system_health(self, authenticated_admin_client):
        ...
        with patch("app.core.monitoring.run_health_check") as mock_health_check:
            ...
            response = authenticated_admin_client.get("/api/admin/system/health")
