...
def test_transcription_endpoints_exist():
    ...
    for path in expected_paths:
        ...
        assert len(matching_routes) > 0, f"Expected transcription endpoint {path} not found"
...
def test_transcription_schemas():
    ...
    from app.schemas.transcription import TranscriptionCreate, AudioChunkForTranscription
