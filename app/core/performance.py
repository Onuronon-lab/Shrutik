...
class PerformanceMetrics:
    ...
    def _update_aggregated_metrics(self, endpoint: str, method: str, duration: float, status_code: int):
    ...
    def get_endpoint_metrics(self, endpoint: str, method: str, days: int = 1) -> Dict[str, Any]:
        ...
        def decorator(func):
            ...
            async def async_wrapper(*args, **kwargs):
                ...
                try:
                    ...
                    endpoint_name = endpoint or (request.url.path if request else func.__name__)
                    ...
                    self.metrics.record_request_time(endpoint_name, method, duration, status_code)
            ...
            def sync_wrapper(*args, **kwargs):
                ...
                try:
                    ...
                    self.metrics.record_request_time(endpoint_name, "SYNC", duration, status_code)
