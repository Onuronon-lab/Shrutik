...
class RateLimitMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next) -> Response:
        ...
        try:
            ...
            if endpoint_limit:
                ...
                if not is_allowed:
                    return self._create_rate_limit_response(rate_info, "Endpoint rate limit exceeded")
            ...
            if burst_limit:
                ...
                if not is_allowed:
                    return self._create_rate_limit_response(rate_info, "Burst rate limit exceeded")
            ...
            if not is_allowed:
                return self._create_rate_limit_response(rate_info, "Rate limit exceeded")
    ...
    def _create_rate_limit_response(self, rate_info: Dict[str, int], message: str) -> Response:
...
class RateLimitManager:
    ...
    def get_user_rate_limit_status(self, user_id: int) -> Dict[str, any]:
        ...
        try:
            ...
            current_count = self.rate_limiter.redis.client.zcount(rate_key, window_start, current_time)
