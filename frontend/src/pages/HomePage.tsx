            ...
            <div className='text-center'>
                <div className='max-w-3xl mx-auto'>
                    ...
                    <p className='text-xl text-gray-600 mb-8'>
                        Help us build better AI by contributing your voice and
                    ...
                    <div className='grid md:grid-cols-3 gap-6'>
                        <div className='text-center'>
                            ...
                            <div className='text-gray-600'>
                                {t('contribution-voice-recording')}
                            </div>
                        </div>
                        <div className='text-center'>
                            ...
                            <div className='text-gray-600'>
                                {t('contribution-transcription')}
                            </div>
                        </div>
                        <div className='text-center'>
                            <div className='text-3xl font-bold text-purple-600 mb-2'>
                                {userStats?.avg_transcription_quality
                                    ? userStats.avg_transcription_quality.toFixed(
                                          1
                                      )
                                    : 'N/A'}
                            </div>
                            <div className='text-gray-600'>
                                {t('contribution-quality-score')}
                            </div>
                        </div>
                    </div>
                )}
